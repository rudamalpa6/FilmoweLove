...
namespace FilmoweLove.Controllers
{
    public class SeriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ID,Nazwa,LiczbaSeznonow,Data,Ocena")] Series series)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,ID,Nazwa,LiczbaSeznonow,Data,Ocena")] Series series)
        {
            if (id != series.ID)
            {
                return NotFound();
